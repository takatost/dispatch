...
public class Net_DeliveryConfirm {

	public Net_DeliveryConfirm(String sn, String job_id, final SuccessCallback successCallback, final FailCallback failCallback) {
		...
		}, Config.KEY_ACTION, Config.ACTION_DELIVERYCONFIRM,
		   Config.KEY_SN, sn,
